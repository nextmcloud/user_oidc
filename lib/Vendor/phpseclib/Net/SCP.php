 ...
 *        exit('bad login');
 *    }
 *    $scp = new \OCA\UserOIDC\Vendor\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SCP::_send()
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \OCA\UserOIDC\Vendor\phpseclib\Net\SSH1|\OCA\UserOIDC\Vendor\phpseclib\Net\SSH2 $ssh
     * @return \OCA\UserOIDC\Vendor\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \OCA\UserOIDC\Vendor\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \OCA\UserOIDC\Vendor\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
